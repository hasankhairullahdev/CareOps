...
export default function NewDoctorPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      await doctorsApi.create(session.accessToken as string, {
        name: form.name,
    ...
    <div className="p-6 max-w-2xl mx-auto space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Add Doctor</h1>
            <p className="text-xs text-gray-400">Create a new doctor profile</p>
          </div>
        </div>
      </div>
